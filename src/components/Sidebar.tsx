        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '13px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginTop: '1px' }}>
              <span style={{ color: 'var(--gold-soft)', fontSize: '9.5px', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Japanese Language Center</span>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/12.png" alt="" aria-hidden="true" style={{ height: '14px', width: 'auto', filter: 'brightness(0) invert(1)', opacity: 0.7 }} />
            </div>
          </div>
        </div>
      </div>
