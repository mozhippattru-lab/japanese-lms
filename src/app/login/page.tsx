    ...
    <div style={{
      ...
      <div
        ...
        <div className="login-img-panel" style={{
          flex: '0 0 300px', background: 'rgba(13,18,40,0.55)',
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: '26px' }}>
              ...
              <div style={{ textAlign: 'right', marginTop: '8px' }}>
                <Link href="/forgot-password" style={{ fontSize: '12.5px', color: 'var(--red)', fontWeight: 600, textDecoration: 'none' }}>Forgot password?</Link>
              </div>
            </div>
      ...
      <style>{`
        ...
        @media (max-width: 580px) {
          ...
          .auth-card > div:last-child { padding: 32px 24px !important; }
        }
