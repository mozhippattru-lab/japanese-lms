        ...
        <section id="about" className="lp-section">
          <div className="lp-container lp-about">
            <div className="lp-about-main">
              ...
              <div className="lp-kural-verse lp-kural-purple" style={{ marginTop: '14px', marginBottom: '24px', border: '2px solid #f9a8d4', borderRadius: '12px', padding: '24px 28px', background: '#fff1f7' }}>
          ...
          <div className="lp-container">
            <div className="lp-annanin-head">
              ...
              <p className="lp-p lp-annanin-lead">
                Some students bear a burden far greater than their fair share. Through <em>அண்ணனின் பரிசு</em>{' '}— <span style={{ color: 'var(--red)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>The Elder Brother&apos;s Gift</span> — we open our Japanese classroom to them, completely free tuition fees. Learning should
      ...
      <footer className="lp-footer">
        <div className="lp-container lp-footer-grid">
          ...
          <div>
            ...
            <span className="lp-fc"><BookOpen size={15} /> Online &amp; in-class · Pan India</span>
          </div>
        </div>
...
function LandingStyles() {
  return (
    <style>{`
      ...
      .lp-kural-purple .lp-kural-num { color: #db2777; }
      .lp-kural-purple .lp-kural-ta { color: #3a2430; }
      .lp-kural-purple .lp-kural-jp { color: #6b4456; }
      .lp-kural-purple .lp-kural-en { color: #8a6377; }
